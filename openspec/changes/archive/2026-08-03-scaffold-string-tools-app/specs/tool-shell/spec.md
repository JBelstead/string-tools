...
The system SHALL render a shared wrapper around the active tool that displays the left-side menu and the active tool's `name` as a title, without constraining what the tool renders below the title.
